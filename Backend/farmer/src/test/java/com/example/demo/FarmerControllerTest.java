...
class FarmerControllerTest {
    ...
    //Creating A Farmer
    Farmer F  = new Farmer("1","kaveesh","kumar","kumar",new Date(),"kumar@gmail.com"
            ,"Vadapalani");
    ...
    public List<Farmer> getlist(){
        ...
        Farmer s = new Farmer("2","kaveesh","kumar","kumar",new Date(),"kumar@gmail.com"
                ,"Vadapalani");
        testfarmers.add(s);
    ...
    @Test
    void addFarmer() {
        Farmer s = new Farmer("1","kaveesh","kumar","kumar",new Date(),"kumar@gmail.com"
                ,"Vadapalani");
